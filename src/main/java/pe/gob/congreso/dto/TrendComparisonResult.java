...
public class TrendComparisonResult {
    ...
    public TrendComparisonResult() {
    }

    public TrendComparisonResult(String trendName1, String trendName2, List<TrendDailyData> trend1Data, List<TrendDailyData> trend2Data, TrendComparisonSummary summary) {
    ...
    public String toString() {
        return "TrendComparisonResult{" +
                ...
                ", trend1Data=" + trend1Data +
                ", trend2Data=" + trend2Data +
                ", summary=" + summary +
                '}';
    }
}
